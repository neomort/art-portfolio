/*
  # Add trigger to update inquiry status on payment completion

  1. New Functions
    - `log_notification_attempt` - Logs notification attempts for debugging
  
  2. Security
    - Function is set as SECURITY DEFINER to ensure it has necessary permissions
*/
