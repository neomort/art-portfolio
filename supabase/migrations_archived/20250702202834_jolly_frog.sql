/*
  # Add longer-term pricing options to properties

  1. New Columns
    - `weekly_rate_type` (text) - Type of weekly rate (fixed or percentage discount)
    - `weekly_rate_value` (numeric) - Value for weekly rate
    - `monthly_rate_type` (text) - Type of monthly rate (fixed or percentage discount)
    - `monthly_rate_value` (numeric) - Value for monthly rate
    - `yearly_rate_type` (text) - Type of yearly rate (fixed or percentage discount)
    - `yearly_rate_value` (numeric) - Value for yearly rate
