/*
  ...
  1. Changes
    - Drop and recreate all inquiry policies with better authentication handling
    - Add policy for profile access for inquiry participants
    - Ensure proper RLS enforcement

  2. Security
    - Users can only view inquiries they created or for properties they own
    - Property owners can update inquiries for their properties
    - Both inquiry creators and property owners can delete inquiries
*/
...
-- Drop existing profile policy for inquiry participants if it exists
